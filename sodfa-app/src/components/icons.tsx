...
export function StarHalfSVG({
  ...
  return (
    ...
    >
      ...
      <path
        d="M12 2l2.9 6.6 7.1.7-5.4 4.8 1.6 7L12 17.4 5.8 21l1.6-7L2 9.3l7.1-.7z"
        fill="currentColor"
        opacity=".22"
      />
      <path
...
export function ShieldSVG({ size = 21 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}
...
export function FlowerSVG() {
  return (
    <svg viewBox="0 0 24 24" width="100%" height="100%">
      <g fill="currentColor">
        <circle cx="12" cy="5" r="3.1" />
        <circle cx="18.7" cy="9.9" r="3.1" />
        <circle cx="16.1" cy="17.6" r="3.1" />
        <circle cx="7.9" cy="17.6" r="3.1" />
        <circle cx="5.3" cy="9.9" r="3.1" />
      </g>
      <circle cx="12" cy="12" r="2.5" fill="#C6A15B" />
    </svg>
  );
}
