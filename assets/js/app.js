(function () {
  ...
  function skeletonFor(id) {
    ...
    var cards = { oils: 4, flash: 2, cases: 2, products: 3, faq: 4, order: 4 }[id] || 4;
  ...
  function sectionName(id) {
    var names = { hero: "الواجهة الرئيسية", stats: "شريط الإحصائيات", trust: "شارات الثقة", flash: "التخفيضات السريعة", oils: "المكونات (الزيوت)", benefits: "مميزات السيروم", video: "الفيديو", cases: "النتائج قبل/بعد", about: "من نحن (قصتنا)", products: "منتجاتنا (المتجر)", faq: "الأسئلة الشائعة", order: "طريقة الطلب", cta: "العرض النهائي", store: "زيارة المتجر", footer: "تذييل الصفحة" };
